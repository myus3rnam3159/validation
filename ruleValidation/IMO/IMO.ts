...
// export function getI03Validation(selectedDate: SelectedDate, workRecords: WorkRecord[]): string | null {

//     const checkDates: SurroundingDates = getSurroundingDates(selectedDate.selectedDate, workRecords.map(wr => wr.workDate),7);
